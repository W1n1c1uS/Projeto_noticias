...
def adm_edit_news(all_news, body_news):
    while True:
        ...
        if edit_id in all_news:
            ...
            yes_or_no = input('Deseja editar as informações da notícia? sim/nao')
            if yes_or_no == 'nao':
                break
            elif yes_or_no == 'sim':
                question3 = input('Edite as informações:')
                body_news[edit_id] = [question3]
